...
export const BirthDays: React.FunctionComponent<IBirthDaysProps> = (props) => { 
  ...
  const formatBirthdayDate = React.useCallback(
    (oldFormatDate: string): string => {
      ...
      // console.log("formatBirthdayDate", exactDay.toLocaleDateString("uk-UK"));
  ...
  (birthday) => {
    ...
    // console.log(birthday + "-" + today.getFullYear());
  ...
  const checkIfActualMonth = (birthday) => {
    ...
    // console.log("date", date, typeof(date), "month", month, typeof(month));   
  ...
  // console.log('filteredCloseBirthdays', filteredCloseBirthdays);
  // console.log('employees', employees);
  // console.log('isLoaded', isLoaded);
  // console.log(checkIfAnyBirthdayCloseToNow('10-03'));  
  // checkIfActualMonth('09-03');
